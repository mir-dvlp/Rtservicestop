    ...
    <div className="relative shrink-0 w-full" data-name="Title Row">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[4px] py-0 relative w-full">
          <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[25px] min-h-px min-w-px not-italic relative shrink-0 text-[20px] text-[rgba(42,51,61,0.96)]">Доступно обновление</p>
        </div>
      </div>
    </div>
  );
...
function DetailRow() {
  return (
    <div className="relative shrink-0 w-full" data-name="Detail Row">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start justify-center px-[4px] py-0 relative w-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[23px] not-italic relative shrink-0 text-[16px] text-[rgba(42,51,61,0.8)] tracking-[-0.16px] w-full">
            Версия приложения обновится с <span className="font-['Inter:Medium',sans-serif] font-medium">11.14.19</span> на <span className="font-['Inter:Medium',sans-serif] font-medium">12.0.0</span>
          </p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[23px] not-italic relative shrink-0 text-[16px] text-[rgba(42,51,61,0.64)] tracking-[-0.16px] w-full">
            Размер обновления: 180 МБ
          </p>
        </div>
      </div>
    </div>
...
function Actions({ onUpdate, onCancel }: { onUpdate: () => void; onCancel: () => void }) {
  return (
  ...
  return (
    <div className="flex items-center justify-center px-[24px] w-full">
      ...
      >
        ...
        <Group />
        <Actions onUpdate={onUpdate} onCancel={onCancel} />
      </div>
    </div>
  );
}
