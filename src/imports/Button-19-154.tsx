import svgPaths from "./svg-y4t7g3760k";
...
export default function Button() {
  return (
    <div className="relative rounded-[9999px] size-full" data-name="Button" style={{ backgroundImage: "linear-gradient(90deg, rgba(252, 254, 255, 0.16) 0%, rgba(252, 254, 255, 0.16) 100%), linear-gradient(90deg, rgb(255, 156, 41) 0%, rgb(255, 156, 41) 100%)" }}>
