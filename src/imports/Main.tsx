import svgPaths from "./svg-vhcgmonw7q";
...
function Frame1() {
  return (
    <div className="box-border content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[16px] items-center leading-[normal] not-italic px-0 py-[24px] relative shrink-0 text-[24px] text-nowrap w-full whitespace-pre">
      <p className="-webkit-box overflow-ellipsis overflow-hidden relative shrink-0 text-[rgba(42,51,61,0.96)]">Установленные</p>
      <p className="-webkit-box overflow-ellipsis overflow-hidden relative shrink-0 text-[rgba(42,51,61,0.64)]">Доступные</p>
    </div>
  );
}
