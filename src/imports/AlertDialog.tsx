...
function Button() {
  return (
    <div className="bg-[#4580f6] h-[48px] relative rounded-[9999px] shrink-0 w-full cursor-pointer select-none overflow-hidden will-change-[opacity] transition-opacity duration-[160ms] ease-out active:opacity-[0.64] after:content-[''] after:absolute after:inset-0 after:rounded-[9999px] after:bg-[rgba(252,254,255,0.16)] after:opacity-0 after:transition-opacity after:duration-[160ms] after:ease-out hover:after:opacity-100" data-name="Button">
...
function Button1() {
  return (
    <div className="bg-[rgba(42,51,61,0.08)] h-[48px] relative rounded-[9999px] shrink-0 w-full transition-all duration-[160ms] ease-out hover:bg-[rgba(42,51,61,0.16)] active:bg-[rgba(42,51,61,0.16)] active:opacity-64 cursor-pointer select-none" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[4px] h-[48px] items-center justify-center p-[16px] relative w-full">
          <LabelPadding1 />
        </div>
